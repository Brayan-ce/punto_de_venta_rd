...
VALUES ('1.0',
        'Términos y Condiciones de Uso - IsiWeek POS',
        '# TÉRMINOS Y CONDICIONES DE USO
        ## Sistema de Punto de Venta IsiWeek
        ...
        **Versión:** 1.0
        ...
        Al registrarse y utilizar el sistema IsiWeek POS, usted acepta estos Términos y Condiciones en su totalidad. Si no está de acuerdo con alguna parte de estos términos, no debe utilizar nuestro servicio.

        La aceptación de estos términos crea un contrato legal vinculante entre usted (el usuario) y IsiWeek.

        ---

        ## 2. DESCRIPCIÓN DEL SERVICIO

        IsiWeek es un sistema de punto de venta (POS) basado en la nube, diseñado para la gestión empresarial integral que incluye:
        ...
        Para utilizar IsiWeek, usted debe:
        ...
        El usuario se compromete a utilizar IsiWeek exclusivamente para:
        ...
        - ❌ Usar el servicio para competir con IsiWeek
        ...
        ### 6.1 Derechos de IsiWeek

        IsiWeek retiene todos los derechos de propiedad intelectual sobre:
        ...
        Se le otorga una licencia limitada, no exclusiva, no transferible y revocable para usar IsiWeek conforme a estos términos.

        ### 6.3 Datos del Usuario

        Usted retiene la propiedad de todos los datos que ingresa al sistema. IsiWeek no reclama propiedad sobre sus datos comerciales.
        ...
        IsiWeek opera bajo un modelo de suscripción mensual o anual según el plan contratado.
        ...
        Usted acepta indemnizar y mantener indemne a IsiWeek de cualquier reclamo derivado de su uso del servicio.
