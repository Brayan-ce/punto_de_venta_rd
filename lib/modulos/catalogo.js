export const MODULOS = {
    ...
    LIBRO_BANCO: {
        codigo: 'libro_banco',
        nombre: 'Libro de Banco',
        categoria: 'finanzas',
        siempreHabilitado: false,
        rutas: ['/admin/finanzas/bancos']
    },
    ...
    SUCURSALES: {
        ...
        rutas: [
            '/admin/sucursales',
            '/admin/sucursales/stock',
            '/admin/sucursales/transferencias',
            '/admin/sucursales/movimientos'
        ]
    },
