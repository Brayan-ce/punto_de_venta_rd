...
export async function POST(request) {
    ...
    try {
        ...
        if (resultado.errores_descarga?.length) {
            return NextResponse.json({
                success: false,
                mensaje: 'No se pudo preparar una copia offline completa. Corrige los errores e intenta de nuevo.',
                errores: resultado.errores_descarga
            }, { status: 500 })
        }
