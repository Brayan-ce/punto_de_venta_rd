...
export default function Header() {
    ...
    const toggleTema = () => {
        const temaActual = document.documentElement.getAttribute('data-theme') || tema
            ...
            <header className={`${estilos.header} ${estilos[tema]} ${tema === 'dark' ? 'dark' : ''}`}>
                <div className={estilos.contenedor}>
                    ...
                    <div className={estilos.acciones}>
                        ...
                        <Link href="/ayuda" className={estilos.botonAyuda} aria-label={language === 'es' ? 'Quiénes somos' : 'About us'}>
                            <ion-icon name="information-circle-outline"></ion-icon>
                            <span>{language === 'es' ? 'Quiénes somos' : 'About us'}</span>
                        </Link>
                        ...
                        <div className={estilos.menuContenido}>
                            <div className={estilos.menuHeader}>
                                {datosPlataforma?.logo_url ? (
                                    ...
                                    <span className={estilos.menuLogoTexto}>IsiWeek</span>
                                )}
                            </div>
