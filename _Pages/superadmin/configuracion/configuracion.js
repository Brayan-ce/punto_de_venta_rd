...
export default function ConfiguracionSuperAdmin() {
    ...
    const validarFormularioPlataforma = () => {
        ...
        } else if (datosPlataforma.nombre_plataforma.length > 30) {
            errores.nombre_plataforma = 'Maximo 30 caracteres'
        }
        ...
        if (datosPlataforma.copyright && datosPlataforma.copyright.length > 120) {
            errores.copyright = 'Maximo 120 caracteres'
        }
        ...
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            <div className={estilos.header}>
                <div>
                    ...
                    <p className={estilos.subtitulo}>{tr('Administra la configuracion de la plataforma y tu perfil', 'Manage platform settings and your profile')}</p>
                </div>
            </div>
            ...
            <div className={estilos.tabs}>
                ...
                >
                    ...
                    <span>{tr('Plataforma', 'Platform')}</span>
                </button>
                <button
                ...
                >
                    ...
                    <span>{tr('Mi Perfil', 'My Profile')}</span>
                </button>
                <button
                ...
                >
                    ...
                    <span>{tr('Términos y Condiciones', 'Terms and Conditions')}</span>
                </button>
            </div>
            ...
            {tabActiva === 'plataforma' && (
                <div className={`${estilos.seccion} ${estilos[tema]}`}>
                    <div className={estilos.seccionHeader}>
                        ...
                        <div>
                            <h2 className={estilos.seccionTitulo}>{tr('Informacion de la Plataforma', 'Platform Information')}</h2>
                            <p className={estilos.seccionSubtitulo}>{tr('Configura los datos generales del sistema', 'Configure the general system information')}</p>
                        </div>
                    </div>

                    <form onSubmit={manejarSubmitPlataforma} className={estilos.formulario}>
                        <div className={estilos.grupoImagen}>
                            <label className={estilos.labelImagen}>{tr('Logo de la Plataforma', 'Platform Logo')}</label>
                            <div className={estilos.contenedorImagen}>
                                ...
                                <label htmlFor="logoInput" className={estilos.btnSubirImagen}>
                                    ...
                                    <span>{tr('Subir Logo', 'Upload Logo')}</span>
                                </label>
                                <p className={estilos.textoAyuda}>{tr('PNG, JPG o JPEG. Maximo 5MB', 'PNG, JPG or JPEG. Maximum 5MB')}</p>
                            </div>
                        </div>

                        <div className={estilos.filaForm}>
                            <div className={estilos.grupoInput}>
                                <label>{tr('Nombre de la Plataforma *', 'Platform Name *')}</label>
                                <input
                                    type="text"
                            ...
                            <div className={estilos.grupoInput}>
                                <label>{tr('Email de Contacto *', 'Contact Email *')}</label>
                                <input
                                    type="email"
                                    name="email_contacto"
                        ...
                        <div className={estilos.filaForm}>
                            <div className={estilos.grupoInput}>
                                <label>{tr('Telefono de Contacto', 'Contact Phone')}</label>
                                <input
                                    type="tel"
                            ...
                            <div className={estilos.grupoInput}>
                                <label>{tr('Telefono WhatsApp', 'WhatsApp Phone')}</label>
                                <input
                                    type="tel"
                        ...
                        <div className={estilos.grupoInput}>
                            <label>{tr('Copyright', 'Copyright')}</label>
                            <input
                                type="text"
                                name="copyright"
                                value={datosPlataforma.copyright}
                                onChange={manejarCambioPlataforma}
                                className={erroresPlataforma.copyright ? estilos.inputError : ''}
                                placeholder="© 2025 IsiWeek. Todos los derechos reservados."
                                maxLength="120"
                            />
                            {erroresPlataforma.copyright && (
                                <span className={estilos.mensajeError}>{erroresPlataforma.copyright}</span>
                            )}
                        </div>
            ...
            {tabActiva === 'perfil' && (
                <div className={`${estilos.seccion} ${estilos[tema]}`}>
                    <div className={estilos.seccionHeader}>
                        ...
                        <div>
                            <h2 className={estilos.seccionTitulo}>{tr('Mi Perfil de Super Administrador', 'My Super Administrator Profile')}</h2>
                            <p className={estilos.seccionSubtitulo}>{tr('Actualiza tu informacion personal', 'Update your personal information')}</p>
                        </div>
                    </div>

                    <form onSubmit={manejarSubmitSuperAdmin} className={estilos.formulario}>
                        <div className={estilos.grupoImagen}>
                            <label className={estilos.labelImagen}>{tr('Foto de Perfil', 'Profile Photo')}</label>
                            <div className={estilos.contenedorImagen}>
                                {previsualizacionAvatar ? (
                                    ...
                                    <div className={estilos.imagenPlaceholder}>
                                        <ion-icon name="person-outline"></ion-icon>
                                        <span>{tr('Sin foto', 'No photo')}</span>
                                    </div>
                                )}
                                <input
                                    type="file"
                        ...
                        <div className={estilos.filaForm}>
                            <div className={estilos.grupoInput}>
                                <label>{tr('Cedula *', 'ID Number *')}</label>
                                <input
                                    type="text"
                                    name="cedula"
                        ...
                        <div className={estilos.grupoInput}>
                            <label>{tr('Nueva Contrasena (dejar vacio para mantener)', 'New Password (leave blank to keep current)')}</label>
                            <input
                                type="password"
                                name="password"
                ...
                <div className={estilos.modalRecorte}>
                    <div className={`${estilos.modalRecorteContenido} ${estilos[tema]}`}>
                        <div className={estilos.modalRecorteHeader}>
                            <h3>{tr('Recortar', 'Crop')} {tipoImagenRecorte === 'logo' ? tr('Logo', 'Logo') : tr('Foto', 'Photo')}</h3>
