                ...
                <div className={estilos.contenedor}>
                    ...
                    <Link href="/superadmin" className={estilos.logo}>
                        {logoPlataforma ? (
                            ...
                            <span className={estilos.logoTexto}>IsiWeek</span>
                        )}
                    </Link>
                    ...
                    <nav className={estilos.navDesktop}>
                        ...
                        <Link href="/superadmin/pagos" className={`${estilos.navItem} ${pathname === '/superadmin/pagos' ? estilos.activo : ''}`}>
                            <ion-icon name="card-outline"></ion-icon>
                            <span>{translateLabel('Pagos')}</span>
                        </Link>
                    ...
                    <div className={`${estilos.menuLateral} ${estilos[tema]}`}>
                        ...
                        <div className={estilos.menuContenido}>
                            ...
                            <nav className={estilos.menuNav}>
                                ...
                                <Link href="/superadmin/pagos" className={`${estilos.menuItem} ${pathname === '/superadmin/pagos' ? estilos.activo : ''}`} onClick={cerrarMenu}>
                                    <ion-icon name="card-outline"></ion-icon>
                                    <span>{translateLabel('Pagos')}</span>
                                </Link>
                            ...
                            <div className={estilos.menuFooter}>
                                <button className={estilos.menuItemTema} onClick={toggleTema}>
                                    <ion-icon name={tema === 'light' ? 'moon-outline' : 'sunny-outline'}></ion-icon>
                                    <span>{tema === 'light' ? (language === 'en' ? 'Dark Mode' : 'Modo Oscuro') : (language === 'en' ? 'Light Mode' : 'Modo Claro')}</span>
                                </button>
                                <button className={estilos.menuItemSalir} onClick={manejarCerrarSesion}>
                                    <ion-icon name="log-out-outline"></ion-icon>
                                    <span>{language === 'en' ? 'Sign Out' : 'Cerrar Sesion'}</span>
                                </button>
                            </div>
                        </div>
                    </div>
