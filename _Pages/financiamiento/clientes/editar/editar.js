...
export default function EditarClienteFinanciamiento() {
    ...
    async function guardar(e) {
        ...
        try {
            ...
            if (res.success) { setExito(true); setTimeout(() => router.push(`/financiamiento/clientes/ver/${id}`), 1200) }
    ...
    if (cargando) return (
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            <div className={estilos.cargando}><div className={estilos.spinner}></div><span>Cargando...</span></div>
        </div>
    )
        ...
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            ...
            <div className={estilos.topbar}>
                <button className={estilos.btnVolver}
                    onClick={() => router.push(`/financiamiento/clientes/ver/${id}`)}>
