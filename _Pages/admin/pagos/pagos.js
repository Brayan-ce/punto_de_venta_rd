...
export default function Pagos() {
    ...
    const handleRegistrarPago = async () => {
        ...
        if (r.success) {
            // Se navega al recibo de inmediato y se sale de esta pantalla, por lo
            // que recargar las listas aqui es innecesario y ademas cancela la
            // navegacion (dos peticiones al mismo tiempo compiten y el router.push
            // se aborta). La pantalla de pagos recarga sus datos al volver.
            setModalPago(null)
            setGuardando(false)
            abrirImprimir(r.pago_id)
            return
        }
