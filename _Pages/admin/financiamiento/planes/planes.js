...
import { obtenerPlanes } from '@/_Pages/admin/planes/servidor'
import estilos from './planes.module.css'
import LoadingScreen from '@/_EXTRAS/Componentes/LoadingScreen/LoadingScreen'

export default function PlanesFinanciamiento({ basePath = '/admin' }) {
    ...
    const navegarANuevo = () => {
        router.push(`${basePath}/planes/nuevo`)
    }

    const navegarAEditar = (planId) => {
        router.push(`${basePath}/planes/editar/${planId}`)
    }

    const navegarAVer = (planId) => {
        router.push(`${basePath}/planes/ver/${planId}`)
    }
