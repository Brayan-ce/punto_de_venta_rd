...
import { obtenerContratos } from '@/_Pages/admin/contratos/servidor'
import { obtenerDatosEmpresa } from '../servidor'
import estilos from './contratos.module.css'
import LoadingScreen from '@/_EXTRAS/Componentes/LoadingScreen/LoadingScreen'

export default function ContratosFinanciamiento({ returnPath = '/admin/financiamiento', basePath = '/admin' }) {
    ...
    return (
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            <div className={estilos.header}>
                ...
                <Link href={returnPath} className={estilos.btnSecundario}>
                                ...
                                <tr key={contrato.id}>
                                    ...
                                    <td>
                                        <div className={estilos.cuotasInfo}>
                                            <span>{contrato.meses} cuotas</span>
                                            <div className={estilos.progresoCuotas}>
                                                <div
                                                    className={estilos.progresoBarra}
                                                    style={{
                                                        width: contrato.saldo_pendiente > 0
                                                            ? `${Math.round((1 - contrato.saldo_pendiente / contrato.monto_financiado) * 100)}%`
                                                            : '100%'
                                                    }}
                                                />
                                            </div>
                                    ...
                                    <td>
                                        <Link
                                            href={`${basePath}/contratos/ver/${contrato.id}`}
