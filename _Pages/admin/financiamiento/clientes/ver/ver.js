    ...
    return (
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            ...
            <div className={estilos.topbar}>
                <button className={estilos.btnVolver} onClick={() => router.push('/admin/financiamiento/clientes')}>
                    <ion-icon name="arrow-back-outline"></ion-icon>
                    Volver
                </button>
                <div className={estilos.topbarAcciones}>
                    <button className={estilos.btnEditar}
                        onClick={() => router.push(`/admin/financiamiento/clientes/editar/${id}`)}>
                        <ion-icon name="create-outline"></ion-icon>
                        Editar
                    </button>
                    <button className={estilos.btnContrato}
                        onClick={() => router.push(`/admin/contratos/nuevo?clienteId=${id}`)}>
                        ...
                        {contratos.map(c => {
                            ...
                            return (
                                <div key={c.id} className={estilos.contratoCard}
                                    onClick={() => router.push(`/admin/contratos/ver/${c.id}`)}>
