...
import { obtenerAlertas } from '@/_Pages/admin/alertas/servidor'
import estilos from './alertas.module.css'
import LoadingScreen from '@/_EXTRAS/Componentes/LoadingScreen/LoadingScreen'

export default function AlertasFinanciamiento({ returnPath = '/admin/financiamiento', basePath = '/admin' }) {
                        ...
                        >
                            ...
                            <div className={estilos.alertaFooter}>
                                ...
                                <div className={estilos.alertaAcciones}>
                                    ...
                                    {alerta.contrato_id && (
                                        <Link
                                            href={`${basePath}/contratos/ver/${alerta.contrato_id}`}
                                            className={estilos.btnAccion}
                                            title="Ver contrato"
                                        >
