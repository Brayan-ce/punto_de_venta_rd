...
import { obtenerControlPresupuestario, obtenerAlertasPresupuesto, obtenerCostosSemanales, marcarAlertaRevisada, obtenerDatosEmpresa } from './servidor'
            ...
            <div className={`${estilos.estadoGeneral} ${estilos[estado.bgLight]}`}>
                ...
                <div className={estilos.progreso}>
                    ...
                    <div className={estilos.progresoFooter}>
                        ...
                        <span>{formatearMoneda(control.presupuesto.total)}</span>
                    </div>
                </div>
                ...
                {control.proyeccion.tiene_sobrecosto && (
                    <div className={estilos.alertaSobrecosto}>
                        ...
                        <p>
                            A la tasa actual de consumo ({formatearMoneda(control.proyeccion.tasa_consumo_diaria)}/día),
                            se proyecta un sobrecosto de <strong>{formatearMoneda(control.proyeccion.sobrecosto)}</strong>
                        </p>
                    </div>
                )}
            </div>
            ...
            <div className={estilos.cardsResumen}>
                <div className={estilos.card}>
                    ...
                    <div>
                        ...
                        <p className={estilos.cardValue}>{formatearMoneda(control.presupuesto.total)}</p>
                    </div>
                </div>
                <div className={estilos.card}>
                    ...
                    <div>
                        ...
                        <p className={estilos.cardValue} style={{ color: '#dc2626' }}>
                            {formatearMoneda(control.presupuesto.ejecutado)}
                        </p>
                ...
                <div className={estilos.card}>
                    ...
                    <div>
                        ...
                        <p className={estilos.cardValue} style={{ color: '#16a34a' }}>
                            {formatearMoneda(control.presupuesto.saldo)}
                        </p>
                            ...
                            <div key={index} className={estilos.itemDistribucion}>
                                <div className={estilos.itemHeader}>
                                    ...
                                    <div className={estilos.itemValor}>
                                        <strong>{formatearMoneda(item.valor)}</strong>
                                        ...
                                        <div className={estilos.semanaHeader}>
                                            ...
                                            <div>
                                                <strong className={excedio ? estilos.excedido : estilos.normal}>
                                                    {formatearMoneda(semana.costo)}
                                                </strong>
                                                <span>Pres: {formatearMoneda(semana.presupuestado)}</span>
                                            </div>
                                        </div>
                    ...
                    <div className={estilos.cardProyeccion}>
                        ...
                        <div className={estilos.proyeccionItems}>
                            ...
                            <div>
                                ...
                                <strong>{formatearMoneda(control.proyeccion.tasa_consumo_diaria)}</strong>
                            </div>
                            <div>
                                <span>Costo proyectado</span>
                                <strong className={control.proyeccion.tiene_sobrecosto ? estilos.excedido : estilos.normal}>
                                    {formatearMoneda(control.proyeccion.costo_proyectado)}
                                </strong>
                            </div>
                            {control.proyeccion.tiene_sobrecosto && (
                                <div className={estilos.sobrecosto}>
                                    <span>Sobrecosto estimado</span>
                                    <strong>{formatearMoneda(control.proyeccion.sobrecosto)}</strong>
                                </div>
                            )}
                        </div>
                    </div>
