...
export async function crearCliente(datosCliente) {
    ...
    try {
        ...
        if (error && error.code === 'MODO_OFFLINE') {
            return {
                success: false,
                mensaje: "La empresa está en modo offline. No se pueden modificar datos en línea. Sube la base de datos modificada desde Configuración → Offline para poder continuar.",
                codigo: 'MODO_OFFLINE'
            };
        }
