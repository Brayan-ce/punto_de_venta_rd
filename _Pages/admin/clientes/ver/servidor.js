    ...
    try {
        ...
        const [rows] = await connection.execute(
            `SELECT c.id,
                    ...
                    -- Subconsulta de deudas CxC (solo ventas a credito)
                    ...
                    COALESCE(d.deuda_total, 0) + COALESCE(fin.saldo_fin, 0) AS deuda_total_general
        ...
        const clienteFormateado = {
            ...
            credito: {
                ...
                utilizado: Number(c.deuda_total) || 0, // solo CxC
                disponible: Math.max(0, Number(c.limite_credito || 0) - Number(c.deuda_total || 0)),
                porcentajeUso: c.limite_credito > 0
                    ? Math.min((Number(c.deuda_total || 0) / c.limite_credito) * 100, 100)
                    : 0,
            ...
            deuda: {
                ...
                totalGeneral: Number(c.deuda_total_general) || 0,
                ...
                financiamiento: Number(c.deuda_financiamiento) || 0,
                contratosActivos: Number(c.contratos_activos) || 0,
            },
        };
