...
const CONFIG_NOTIF_DEFAULT = {
    ...
    notif_sonido_activo: 0,
    notif_sonido_tono: 'campanilla',
}

const TONOS_VALIDOS = new Set(['campanilla', 'suave', 'alerta', 'digital'])
    ...
    try {
        ...
        return {
            ...
            config: {
                ...
                notif_sonido_activo: fila.notif_sonido_activo == null ? !!CONFIG_NOTIF_DEFAULT.notif_sonido_activo : !!fila.notif_sonido_activo,
                notif_sonido_tono: TONOS_VALIDOS.has(fila.notif_sonido_tono) ? fila.notif_sonido_tono : CONFIG_NOTIF_DEFAULT.notif_sonido_tono,
            }
        }
    } catch (error) {
...
export async function actualizarNotificacionesConfig(opciones = {}) {
    ...
    try {
        ...
        const tonoValor = TONOS_VALIDOS.has(opciones.notif_sonido_tono) ? opciones.notif_sonido_tono : CONFIG_NOTIF_DEFAULT.notif_sonido_tono
        ...
        await connection.execute(
            ...
            [
                ...
                diasValor,
                opciones.notif_sonido_activo === undefined ? CONFIG_NOTIF_DEFAULT.notif_sonido_activo : (opciones.notif_sonido_activo ? 1 : 0),
                tonoValor,
                empresaId
            ]
        )
        ...
        return {
            ...
            config: {
                ...
                notif_sonido_activo: opciones.notif_sonido_activo === undefined ? !!CONFIG_NOTIF_DEFAULT.notif_sonido_activo : !!opciones.notif_sonido_activo,
                notif_sonido_tono: tonoValor,
            },
