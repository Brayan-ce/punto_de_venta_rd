...
import {crearTrabajador, obtenerDatosEmpresa} from '../servidor'
...
export default function NuevoTrabajador() {
    ...
    const formatearMoneda = (v) => {
        try {
            return new Intl.NumberFormat(empresa?.locale || 'es-DO', { minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(Number(v) || 0)
        } catch {
                    ...
                    <div className={estilos.layoutPrincipal}>
                        <div className={estilos.columnaIzquierda}>
                            ...
                            <div className={`${estilos.seccion} ${estilos[tema]}`}>
                                ...
                                <div className={estilos.grid2}>
                                    <div className={estilos.grupo}>
                                        <label className={estilos.label}>Tarifa por Hora ({simboloMoneda})</label>
                                        <div className={estilos.inputConPrefijo}>
                                            <span className={estilos.prefijo}>{simboloMoneda}</span>
                                            <input
                                                type="number"
                                    ...
                                    <div className={estilos.grupo}>
                                        <label className={estilos.label}>Tarifa por Día ({simboloMoneda})</label>
                                        <div className={estilos.inputConPrefijo}>
                                            <span className={estilos.prefijo}>{simboloMoneda}</span>
                                            <input
                                                type="number"
                                        ...
                                        <div className={estilos.tarifasInfo}>
                                            {formData.tarifa_por_hora && (
                                                <div className={estilos.tarifaItem}>
                                                    <span>Por hora:</span>
                                                    <strong>{simboloMoneda} {formatearMoneda(formData.tarifa_por_hora)}</strong>
                                                </div>
                                            )}
                                            {formData.tarifa_por_dia && (
                                                <div className={estilos.tarifaItem}>
                                                    <span>Por día:</span>
                                                    <strong>{simboloMoneda} {formatearMoneda(formData.tarifa_por_dia)}</strong>
                                                </div>
                                            )}
                                            {formData.tarifa_por_dia && (
                                                <div className={estilos.tarifaItem}>
                                                    <span>Semanal (5 días):</span>
                                                    <strong>{simboloMoneda} {formatearMoneda(parseFloat(formData.tarifa_por_dia) * 5)}</strong>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                            ...
                                            {formData.tarifa_por_hora && (
                                                <div className={estilos.resumenItem}>
                                                    ...
                                                    <span className={estilos.resumenValorDestacado}>
                                                        {simboloMoneda} {formatearMoneda(formData.tarifa_por_hora)}
                                                    </span>
                                                </div>
                                            )}
                                            {formData.tarifa_por_dia && (
                                                <div className={estilos.resumenItem}>
                                                    ...
                                                    <span className={estilos.resumenValorDestacado}>
                                                        {simboloMoneda} {formatearMoneda(formData.tarifa_por_dia)}
                                                    </span>
                                                </div>
                                            )}
                                        </div>
