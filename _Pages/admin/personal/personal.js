...
import {obtenerTrabajadores, obtenerPersonalEnCampo, obtenerEstadisticasPersonal, obtenerDatosEmpresa} from './servidor'
        ...
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            ...
            {vista === 'en_campo' && (
                <>
                    ...
                    {cargando ? <LoadingScreen /> : personalActivo.length === 0 ? (
                                ...
                                <div key={trabajador.id} className={estilos.filaTrabajador}>
                                    ...
                                    {trabajador.tarifa_por_hora && (
                                        <div className={estilos.trabajadorTarifa}>
                                            <span className={estilos.tarifaValor}>{simboloMoneda}{trabajador.tarifa_por_hora}</span>
