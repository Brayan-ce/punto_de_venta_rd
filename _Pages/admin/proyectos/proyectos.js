...
import { obtenerProyectos, obtenerDatosEmpresa } from './servidor'
...
export default function ProyectosAdmin() {
    ...
    return (
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            ...
            {cargando ? <LoadingScreen /> : proyectos.length === 0 ? (
                                    ...
                                    <div className={estilos.info}>
                                        ...
                                        {proyecto.presupuesto_total > 0 && (
                                            <div className={estilos.itemInfo}>
                                                ...
                                                <span>{formatearMoneda(proyecto.presupuesto_total)}</span>
                                            </div>
                                        )}
                                        <div className={estilos.itemInfo}>
