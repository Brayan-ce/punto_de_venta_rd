...
import { crearProyecto, obtenerEstadisticasProyectos, obtenerUsuariosResponsables, obtenerEtiquetasExistentes, obtenerPlantillasProyectos, obtenerDatosEmpresa } from '../servidor'
                ...
                <section className={estilos.seccion}>
                    ...
                    <div className={estilos.grid}>
                        <div className={estilos.grupo}>
                            ...
                            {estadisticas.presupuestoPromedio > 0 && (
                                <span className={estilos.ayuda}>
                                    Presupuesto promedio: {formatearMoneda(estadisticas.presupuestoPromedio)}
                                </span>
                            )}
                        </div>
