    ...
    return (
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            <div className={estilos.header}>
                <div>
                    <h1 className={estilos.titulo}>{tr('Editar Compra', 'Edit Purchase')}</h1>
                    <p className={estilos.subtitulo}>{tr('Modifica los datos de la compra', 'Modify purchase data')}</p>
                </div>
                <button
                    type="button"
            ...
            <form onSubmit={manejarSubmit} className={estilos.formulario}>
                <div className={estilos.fila}>
                    ...
                    <div className={`${estilos.panel} ${estilos[tema]}`}>
                        ...
                        >
                            {procesando ? tr('Actualizando...', 'Updating...') : tr('Actualizar Compra', 'Update Purchase')}
                        </button>
                    </div>
                </div>
