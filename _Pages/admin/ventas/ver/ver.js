...
export default function VerVentaAdmin({ returnPath = '/admin/ventas', basePath = '/admin' }) {
    ...
    const simboloEmpresa = empresa?.simbolo_moneda || 'RD$'
        ...
        <div className={`${estilos.contenedor} ${estilos[tema]}`}>
            <div className={estilos.header}>
                ...
                <div className={estilos.headerAcciones}>
                    <Link
                        href={`${basePath}/ventas/imprimir/${venta.id}`}
                    ...
                    {venta.estado === 'emitida' && (
                        <Link
                            href={`${basePath}/ventas/editar/${venta.id}`}
                    ...
                    {venta.tipo_entrega === 'parcial' && !venta.despacho_completo && venta.estado === 'emitida' && (
                        <Link
                            href={`${basePath}/ventas/despachar/${venta.id}`}
