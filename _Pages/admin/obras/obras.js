...
import { obtenerObras, obtenerDatosEmpresa } from './servidor'
                                    ...
                                    {porcentajeEjecutado > 0 && (
                                        <div className={estilos.progresoPresupuesto}>
                                            ...
                                            <div className={estilos.progresoDetalles}>
                                                <span>
                                                    Ejecutado: <strong>{simboloMoneda} {new Intl.NumberFormat(localeEmpresa, { minimumFractionDigits: 2 }).format(parseFloat(o.costo_real || o.costo_ejecutado || 0))}</strong>
                                                </span>
                                                <span>
                                                    Presupuesto: <strong>{simboloMoneda} {new Intl.NumberFormat(localeEmpresa, { minimumFractionDigits: 2 }).format(parseFloat(o.presupuesto_aprobado || 0))}</strong>
                                                </span>
                                                <span>
                                                    Restante: <strong>{simboloMoneda} {new Intl.NumberFormat(localeEmpresa, { minimumFractionDigits: 2 }).format(parseFloat((o.presupuesto_aprobado || 0) - (o.costo_real || o.costo_ejecutado || 0)))}</strong>
                                                </span>
                                            </div>
                                        </div>
                                    )}
